...
Detailed instructions on configuring and securing an Ubuntu Linux Server and then deploying a Flask web application: specifically [*Calla Grocers*](https://github.com/antzie/catalog) a catalogue application developed as project (?) for Udacity's Full-Stack Nanodegree. 
___
